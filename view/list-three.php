<?php
$tm = '<section id="'.$colors_theme.'" class="WordPress_Testimonials-list"><div class="style-three">' . "\n";
$counter = 1;
while( $WordPress_Testimonials->have_posts() ): $WordPress_Testimonials->the_post();
  ...
  $tm .= '<article class="WordPress_Testimonials-'.get_the_ID().' WordPress_Testimonials ">' . "\n";
